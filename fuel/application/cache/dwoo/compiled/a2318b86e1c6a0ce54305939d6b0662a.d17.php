...
<head>
	<meta charset="utf-8">
 	<title>
		<!--__FUEL_MARKER__0-->Create a new page	</title>

	<meta name="keywords" content="<!--__FUEL_MARKER__1-->page, new page">
	<meta name="description" content="<!--__FUEL_MARKER__2-->new page, create new page">

	<link href='http://fonts.googleapis.com/css?family=Raleway:400,700' rel='stylesheet' type='text/css'>
	<link href="/assets/css/main.css?c=" media="all" rel="stylesheet"/>
		<script src="//ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script><script>window.jQuery || document.write('<script src="/assets/js/jquery.js?c="><\/script>');</script></head>
<body>
	...
	<div class="page">
		<div class="wrapper">
			<header class="page_header">
				...
				<h1><!--__FUEL_MARKER__3-->Đ&acirc;y l&agrave; trang mới</h1>
			</header>			
	<section id="main_inner">
		<!--__FUEL_MARKER__4-->Nội dung trang mới	</section>
	...
	<footer class="row footer">
		...
		<p class="colophon">FUEL CMS is developed with love by <a href="http://thedaylightstudio.com" target="_blank">Daylight Studio</a> 
			...
			&copy; 2017 Run for Daylight LLC, All Rights Reserved.</p>
	</footer>
</div>
